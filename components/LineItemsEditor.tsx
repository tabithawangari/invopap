// components/LineItemsEditor.tsx — Editable line items table
"use client";

import { useInvoiceStore, type InvoiceLineItem } from "@/lib/store/invoiceStore";
  ...
  return (
    <div className="group rounded-lg border border-mist p-3 md:p-0 md:border-0">
      <div className="grid grid-cols-12 gap-2 items-start">
        ...
        {/* Delete — mobile: visible at top-right of card */}
