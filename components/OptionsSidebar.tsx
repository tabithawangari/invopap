// components/OptionsSidebar.tsx — Settings sidebar with doc-type nav and actions
"use client";

import { useInvoiceStore, ACCENT_COLORS } from "@/lib/store/invoiceStore";
...
export function OptionsSidebar({
  ...
  return (
    <div className="space-y-5 p-4 bg-white rounded-xl border border-mist">
      ...
      {/* ─── Document Type ─── */}
      <DocumentTypeSwitcher variant="sidebar" fallbackLabel="Invoice" />
