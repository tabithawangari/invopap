// components/QuotationLineItemsEditor.tsx — Editable line items table for Quotations
"use client";

import { useQuotationStore, type QuotationLineItem } from "@/lib/store/quotationStore";
import { formatCurrency } from "@/lib/utils/format";

export function QuotationLineItemsEditor() {
  const items = useQuotationStore((s) => s.items);
  const currency = useQuotationStore((s) => s.currency);
